...
<section class="mt-8 border border-gray-400 px-4 py-2 text-center rounded-lg">
...
<section class="grid grid-cols-2 gap-2 p-4 h-42 border border-gray-400 rounded-lg mt-8">
